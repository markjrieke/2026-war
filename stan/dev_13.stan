...
generated quantities {
    ...
    vector[N] Y_rep = inv_logit(to_vector(normal_rng(mu, sigma)));
    ...
    vector[N] beta_c_dem = to_vector(normal_rng(rep_vector(0, N), 1)) * sigma_c;
    vector[N] beta_c_rep = to_vector(normal_rng(rep_vector(0, N), 1)) * sigma_c;
    vector[N] mu_dem;
    vector[N] mu_rep;
    {
        vector[N] gamma;
    ...
    Y_rep_cf[1] = inv_logit(to_vector(normal_rng(mu_dem, sigma)));
    Y_rep_cf[2] = inv_logit(to_vector(normal_rng(mu_rep, sigma)));
